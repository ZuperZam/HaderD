...
POSITIVE_GUESS_IMAGES_PATH = './guess_positive'
...
dataset_guess = dataset_guess(dataset_guess.shape[0], image_size*image_size*3)
...
####################################################################
guess = cross_val_predict(sgd_clf_noisy, dataset_guess, y_guess, cv=3)
print(guess)
####################################################################
