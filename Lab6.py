...
time_stop = time.time()
print("Gaussian_Fit Time: ", time_stop-time_start)
time_start = time.time()
multiNB.fit(X_train, y_train)
time_stop = time.time()
print("Multinomial_Fit Time: ", time_stop-time_start)
time_start = time.time()
bernoNB.fit(X_train, y_train)
time_stop = time.time()
print("Bernoulli_Fit Time: ", time_stop-time_start)
time_start = time.time()
sgd_clf.fit(X_train, y_train)
time_stop = time.time()
print("SGD_Fit Time: ", time_stop-time_start, "\n")
